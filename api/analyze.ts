...
SCHEMA:
{
  "item": "Detailed item name with brand and model",
  "item_category": "Clothing & Apparel | Sneakers & Footwear | Electronics & Gadgets | Antiques & Collectibles | Home & Living | Books & Media",
  "item_name": "string",
  "brand": "string or null",
  "conditionScore": 8,
  "condition_score": 8,
  "defects": ["List of visible wear, marks, or defects if any"],
  "priceNz": {
    "low": 0,
    "mid": 0,
    "high": 0
